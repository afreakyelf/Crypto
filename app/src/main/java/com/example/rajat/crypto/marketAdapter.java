...
public class marketAdapter extends RecyclerView.Adapter<marketAdapter.ViewHolder> {
    ...
    @NonNull
    @Override
    public marketAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull final marketAdapter.ViewHolder viewHolder, final int i) {
